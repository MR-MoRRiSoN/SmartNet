...
public class GMailer {
    ...
    public GMailer() throws Exception {
        ...
        service = new Gmail.Builder(httpTransport, jsonFactory, getCredentials(httpTransport, jsonFactory)).setApplicationName("Test Mailer").build();
    }

    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory) throws IOException {
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new InputStreamReader(GMailer.class.getResourceAsStream("/client_secret_899270370194-ldvd15a77a9h189a25v81p2rkokr65dd.apps.googleusercontent.com.json")));
    ...
    public void sendMail(String subject, String message, String TEST_EMAIL) throws Exception {
